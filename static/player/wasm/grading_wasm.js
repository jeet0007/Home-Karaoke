/* @ts-self-types="./grading_wasm.d.ts" */
...
export class Grader {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        GraderFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_grader_free(ptr, 0);
    }
    /**
     ...
     * @param {string | null} [melody_json]
     */
    constructor(sample_rate, melody_json) {
        var ptr0 = isLikeNone(melody_json) ? 0 : passStringToWasm0(melody_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        const ret = wasm.grader_new(sample_rate, ptr0, len0);
        this.__wbg_ptr = ret;
        GraderFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    push_samples(chunk) {
        ...
        let deferred2_1;
        try {
            const ptr0 = passArrayF32ToWasm0(chunk, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.grader_push_samples(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
     ...
     */
    set_position(pos_ms) {
        wasm.grader_set_position(this.__wbg_ptr, pos_ms);
    }
}
if (Symbol.dispose) Grader.prototype[Symbol.dispose] = Grader.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./grading_wasm_bg.js": import0,
    };
}

const GraderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_grader_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('grading_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
